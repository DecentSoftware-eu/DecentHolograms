...
public interface HeadHologramLine extends HologramLine {
    ...
    /**
     * Get the facing direction of the head. This is the angle in degrees
     * that the head is facing.
     * <p>
     * This value overrides the default facing direction of the hologram.
     *
     * @return The facing direction of the head in degrees.
     * @since 2.10.0
     */
    float getFacing();

    /**
     * Set the facing direction of the head. This is the angle in degrees
     * that the head is facing.
     * <p>
     * This value overrides the default facing direction of the hologram.
     *
     * @param facing The facing direction of the head in degrees. Must be between 0 and 360.
     * @since 2.10.0
     */
