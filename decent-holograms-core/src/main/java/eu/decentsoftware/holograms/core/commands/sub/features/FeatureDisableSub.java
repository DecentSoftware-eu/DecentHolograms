...
public class FeatureDisableSub extends DecentCommand {

	public FeatureDisableSub() {
		super("disable", "dh.features.admin", false, "off");
	}
	...
	public String getUsage() {
		return "/dh feature disable <feature>";
	}

	@Override
	public String getDescription() {
		return "Disable a Feature.";
	}
