...
public class UpdateDisplayContentIntentMaterializer implements IntentMaterializer<IntentDescriptor.UpdateDisplayContent> {

    private final DisplayContentPostProcessingService postProcessingService;

    public UpdateDisplayContentIntentMaterializer(DisplayContentPostProcessingService postProcessingService) {
