...
public class SpawnDisplayIntentMaterializer implements IntentMaterializer<IntentDescriptor.SpawnDisplay> {

    private final DisplayContentPostProcessingService postProcessingService;

    public SpawnDisplayIntentMaterializer(DisplayContentPostProcessingService postProcessingService) {
