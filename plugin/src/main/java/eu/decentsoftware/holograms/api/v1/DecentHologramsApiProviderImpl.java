...
import eu.decentsoftware.holograms.api.v1.hologram.ApiHologramFactory;
...
public class DecentHologramsApiProviderImpl extends DecentHologramsApiProvider {
    ...
    public DecentHologramsApiProviderImpl() {
        DecentHologramsApiProvider.setImplementation(this);
    }
