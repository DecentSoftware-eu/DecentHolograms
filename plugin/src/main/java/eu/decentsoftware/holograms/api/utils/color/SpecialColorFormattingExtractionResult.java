...
public final class SpecialColorFormattingExtractionResult {
    private final String cleanedString;
    private final String specialFormatting;

    SpecialColorFormattingExtractionResult(String cleanedString, String specialFormatting) {
