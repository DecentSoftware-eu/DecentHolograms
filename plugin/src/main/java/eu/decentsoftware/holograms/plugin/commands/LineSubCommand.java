...
public class LineSubCommand extends DecentCommand {
    ...
    public LineSubCommand(HologramManager hologramManager, CommandManager commandManager) {
        super("lines");

        addSubCommand(new LineHelpSub(commandManager));
        addSubCommand(new LineAddSub(hologramManager));
        addSubCommand(new LineInsertSub(hologramManager));
        addSubCommand(new LineSetSub(hologramManager));
        addSubCommand(new LineEditSub(hologramManager));
        addSubCommand(new LineRemoveSub(hologramManager));
        addSubCommand(new LineInfoSub(hologramManager));
        addSubCommand(new LineSwapSub(hologramManager));
        addSubCommand(new LineAlignSub(hologramManager));
        addSubCommand(new LineHeightSub(hologramManager));
        addSubCommand(new LineOffsetXSub(hologramManager));
        addSubCommand(new LineOffsetZSub(hologramManager));
        addSubCommand(new LineFlagAddSub(hologramManager));
        addSubCommand(new LineFlagRemoveSub(hologramManager));
        addSubCommand(new LinePermissionSub(hologramManager));
        addSubCommand(new LineFacingSub(hologramManager));
    }
    ...
    static class LineAddSub extends DecentCommand {
        ...
        public LineAddSub(HologramManager hologramManager) {
            super("add");
        ...
        public TabCompleteHandler getTabCompleteHandler() {
            return (sender, args) -> {
                if (args.length <= 2) {
                    return handleCommonArgs(args, hologramManager);
                } else {
    ...
    static class LineAlignSub extends DecentCommand {
        ...
        public LineAlignSub(HologramManager hologramManager) {
            super("align");
            this.hologramManager = hologramManager;
        }
        ...
        public TabCompleteHandler getTabCompleteHandler() {
            return (sender, args) -> {
                if (args.length <= 3) {
                    ...
                    return getLines(args[0], Validator.getInteger(args[1]), args[3], hologramManager);
    ...
    static class LineEditSub extends DecentCommand {
        ...
        public LineEditSub(HologramManager hologramManager) {
            super("edit");
            this.hologramManager = hologramManager;
        }
        ...
        @Override
        public TabCompleteHandler getTabCompleteHandler() {
            return (sender, args) -> handleCommonArgs(args, hologramManager);
        }
    ...
    static class LineFlagAddSub extends DecentCommand {
        ...
        public LineFlagAddSub(HologramManager hologramManager) {
            super("addflag");
            this.hologramManager = hologramManager;
        }
    ...
    static class LineFlagRemoveSub extends DecentCommand {
        ...
        public LineFlagRemoveSub(HologramManager hologramManager) {
            super("removeflag");
            this.hologramManager = hologramManager;
        }
    ...
    static class LineHeightSub extends DecentCommand {
        ...
        public LineHeightSub(HologramManager hologramManager) {
            super("height");
            this.hologramManager = hologramManager;
        }
    ...
    static class LineHelpSub extends DecentCommand {
        ...
        public LineHelpSub(CommandManager commandManager) {
            super("help");
        ...
        public CommandHandler getCommandHandler() {
            return (sender, args) -> {
                ...
                sender.sendMessage("");
                CommandBase command = commandManager.getMainCommand().getSubCommand("lines");
    ...
    static class LineInfoSub extends DecentCommand {
        ...
        public LineInfoSub(HologramManager hologramManager) {
            super("info");
            this.hologramManager = hologramManager;
        }
    ...
    static class LineInsertSub extends DecentCommand {
        ...
        public LineInsertSub(HologramManager hologramManager) {
            super("insert");
            this.hologramManager = hologramManager;
        }
    ...
    static class LineOffsetXSub extends DecentCommand {
        ...
        public LineOffsetXSub(HologramManager hologramManager) {
            super("offsetx");
            this.hologramManager = hologramManager;
        }
    ...
    static class LineOffsetZSub extends DecentCommand {
        ...
        public LineOffsetZSub(HologramManager hologramManager) {
            super("offsetz");
            this.hologramManager = hologramManager;
        }
    ...
    static class LinePermissionSub extends DecentCommand {
        ...
        public LinePermissionSub(HologramManager hologramManager) {
            super("setpermission");
            this.hologramManager = hologramManager;
        }
    ...
    static class LineRemoveSub extends DecentCommand {
        ...
        public LineRemoveSub(HologramManager hologramManager) {
            super("remove");
            this.hologramManager = hologramManager;
        }
    ...
    static class LineSetSub extends DecentCommand {
        ...
        public LineSetSub(HologramManager hologramManager) {
            super("set");
            this.hologramManager = hologramManager;
        }
    ...
    static class LineSwapSub extends DecentCommand {
        ...
        public LineSwapSub(HologramManager hologramManager) {
            super("swap");
            this.hologramManager = hologramManager;
        }
    ...
    public static class LineFacingSub extends DecentCommand {
        ...
        public LineFacingSub(HologramManager hologramManager) {
            super("setfacing");
            this.hologramManager = hologramManager;
        }
    ...
    protected static List<String> handleCommonArgs(String[] args, HologramManager hologramManager) {
        if (args.length == 1) {
            return getHologramNames(args[0], hologramManager);
        } else if (args.length == 2) {
            return getPages(args[0], args[1], hologramManager);
        } else if (args.length == 3) {
            return getLines(args[0], Validator.getInteger(args[1]), args[2], hologramManager);
        }

        return Collections.emptyList();
    }

    protected static List<String> getHologramNames(String token, HologramManager hologramManager) {
        return TabCompleteHandler.getPartialMatches(token, hologramManager.getHologramNames());
    }
    ...
    protected static List<String> getPages(String hologramName, String token, HologramManager hologramManager) {
    ...
    protected static List<String> getLines(String hologramName, int pageIndex, String token, HologramManager hologramManager) {
        Hologram hologram = hologramManager.getHologram(hologramName);
