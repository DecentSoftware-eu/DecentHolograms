...
public class HologramSubCommand extends DecentCommand {
    ...
    public HologramSubCommand(HologramManager hologramManager, CommandManager commandManager) {
        super("holograms");

        addSubCommand(new HologramHelpSub(commandManager));
        addSubCommand(new HologramEnableSub());
        addSubCommand(new HologramDisableSub());
        addSubCommand(new HologramCreateSub(hologramManager));
        addSubCommand(new HologramUpdateSub());
        addSubCommand(new HologramCloneSub(hologramManager));
        addSubCommand(new HologramDeleteSub(hologramManager));
        ...
        addSubCommand(new HologramMoveSub(hologramManager));
        addSubCommand(new HologramCenterSub());
        addSubCommand(new HologramAlignSub(hologramManager));
        addSubCommand(new HologramNearSub(hologramManager));
        addSubCommand(new HologramDownOriginSub(hologramManager));
        addSubCommand(new HologramFacingSub(hologramManager));
        addSubCommand(new HologramFlagAddSub(hologramManager));
        addSubCommand(new HologramFlagRemoveSub(hologramManager));
        ...
        addSubCommand(new HologramRenameSub(hologramManager));
    }
    ...
    public static class HologramAlignSub extends DecentCommand {
        ...
        public HologramAlignSub(HologramManager hologramManager) {
            super("align");
    ...
    public static class HologramCloneSub extends DecentCommand {
        ...
        public HologramCloneSub(HologramManager hologramManager) {
            super("clone");
            this.hologramManager = hologramManager;
        }
        ...
        public CommandHandler getCommandHandler() {
            return (sender, args) -> {
                ...
                clone.showAll();
                clone.realignLines();
                hologramManager.registerHologram(clone);
    ...
    public static class HologramCreateSub extends DecentCommand {
        ...
        public HologramCreateSub(HologramManager hologramManager) {
            super("create");
            this.hologramManager = hologramManager;
        }
        ...
        public CommandHandler getCommandHandler() {
            return (sender, args) -> {
                ...
                if (hologramManager.containsHologram(hologramName)) {
    ...
    public static class HologramDeleteSub extends DecentCommand {
        ...
        public HologramDeleteSub(HologramManager hologramManager) {
            super("delete");
            this.hologramManager = hologramManager;
        }
        ...
        public CommandHandler getCommandHandler() {
            return (sender, args) -> {
                ...
                hologramManager.removeHologram(args[0]);
    ...
    public static class HologramDownOriginSub extends DecentCommand {
        ...
        public HologramDownOriginSub(HologramManager hologramManager) {
            super("downorigin");
            this.hologramManager = hologramManager;
        }
    ...
    public static class HologramFacingSub extends DecentCommand {
        ...
        public HologramFacingSub(HologramManager hologramManager) {
            super("setfacing");
            this.hologramManager = hologramManager;
        }
    ...
    public static class HologramFlagAddSub extends DecentCommand {
        ...
        public HologramFlagAddSub(HologramManager hologramManager) {
            super("addflag");
            this.hologramManager = hologramManager;
        }
    ...
    public static class HologramFlagRemoveSub extends DecentCommand {
        ...
        public HologramFlagRemoveSub(HologramManager hologramManager) {
            super("removeflag");
            this.hologramManager = hologramManager;
        }
    ...
    public static class HologramHelpSub extends DecentCommand {
        ...
        public HologramHelpSub(CommandManager commandManager) {
            super("help");
        ...
        public CommandHandler getCommandHandler() {
            return (sender, args) -> {
                ...
                sender.sendMessage("");
                CommandBase command = commandManager.getMainCommand().getSubCommand("holograms");
    ...
    public static class HologramMoveSub extends DecentCommand {
        ...
        public HologramMoveSub(HologramManager hologramManager) {
            super("move");
            this.hologramManager = hologramManager;
        }
        ...
        public TabCompleteHandler getTabCompleteHandler() {
            return (sender, args) -> {
                ...
                if (args.length == 1) {
                    ...
                    hologram = hologramManager.getHologram(args[0]);
    ...
    public static class HologramNearSub extends DecentCommand {
        ...
        public HologramNearSub(HologramManager hologramManager) {
            super("near");
            this.hologramManager = hologramManager;
        }
    ...
    public static class HologramRenameSub extends DecentCommand {
        ...
        public HologramRenameSub(HologramManager hologramManager) {
            super("rename");
            this.hologramManager = hologramManager;
        }
        ...
        public CommandHandler getCommandHandler() {
            return (sender, args) -> {
                ...
                hologramManager.registerHologram(newHologram);
                newHologram.showAll();
