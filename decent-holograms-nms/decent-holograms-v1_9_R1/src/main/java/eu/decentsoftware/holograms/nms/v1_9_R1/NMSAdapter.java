...
public class NMSAdapter implements eu.decentsoftware.holograms.api.nms.NMSAdapter {
	...
	static {
		random = new Random();
		entityData = new ReflectField<DataWatcherObject<Byte>>(Entity.class, "ax").getValue(null);
		customName = new ReflectField<DataWatcherObject<String>>(Entity.class, "az").getValue(null);
	...
	public void showFakeItem(@NonNull final Player player, @NonNull final Location location, final int entityId, @NonNull final org.bukkit.inventory.ItemStack itemStack) {
		...
		dataWatcher.register(item, Optional.fromNullable(CraftItemStack.asNMSCopy(itemStack)));
