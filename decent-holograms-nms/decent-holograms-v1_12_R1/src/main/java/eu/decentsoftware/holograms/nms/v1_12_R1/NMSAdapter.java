...
public class NMSAdapter implements eu.decentsoftware.holograms.api.nms.NMSAdapter {
	...
	private static final DataWatcherObject<Optional<ItemStack>> item;
	...
	static {
		...
		customName = new ReflectField<DataWatcherObject<String>>(Entity.class, "aB").getValue(null);
		customNameVisible = new ReflectField<DataWatcherObject<Boolean>>(Entity.class, "aC").getValue(null);
		armorStandData = new ReflectField<DataWatcherObject<Byte>>(EntityArmorStand.class, "a").getValue(null);
		item = new ReflectField<DataWatcherObject<Optional<ItemStack>>>(EntityItem.class, "c").getValue(null);
		...
		mapEntityTypes.put(EntityType.ILLUSIONER, new Pair<>(37, 1.8f));
		...
		mapEntityTypes.put(EntityType.PARROT, new Pair<>(105, 1.8f));
