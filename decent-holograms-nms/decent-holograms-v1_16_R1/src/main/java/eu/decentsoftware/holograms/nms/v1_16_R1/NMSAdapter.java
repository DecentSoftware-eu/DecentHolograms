...
public class NMSAdapter implements eu.decentsoftware.holograms.api.nms.NMSAdapter {
	...
	static {
		...
		customName = new ReflectField<DataWatcherObject<Optional<IChatBaseComponent>>>(Entity.class, "ax").getValue(null);
		customNameVisible = new ReflectField<DataWatcherObject<Boolean>>(Entity.class, "ay").getValue(null);
